...
//Exercise 1:
let veryOldInventors = inventors.filter((inventors, veryOldInventors) => {
...
let idx = comments.findIndex((comment, idx) => {
...
let totalYearsLived = inventors.reduce((accumulato,inventors) =>{
  return accumulato + (inventors.passed - inventors.year);
